...
function extractSongInfo() {
    ...
    if (service === 'Amazon Music') {
        ...
        let currentTitle = songItemElement ? songItemElement.getAttribute('primary-text') : '';
        let currentArtist = songItemElement ? songItemElement.getAttribute('secondary-text') : '';
