...
function getCurrentService() {
    ...
    if (hostname.includes('amazon.com') || hostname.includes('music.amazon')) {
        return 'Amazon Music';
    } else {
        return 'Unknown';
    }
...
function extractSongInfo() {
    ...
    if (service === 'Amazon Music') {
        let songTitleElement = document.querySelector('music-horizontal-item'); // Updated selector
        let currentTitle = songTitleElement ? songTitleElement.getAttribute('primary-text') : '';
        let currentArtist = songTitleElement ? songTitleElement.getAttribute('secondary-text') : '';
