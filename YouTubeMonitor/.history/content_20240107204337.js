...
function extractSongInfo() {
    ...
    if (service === 'Amazon Music') {
        // Update these selectors based on the actual structure of Amazon Music's web page
        let songTitleElement = document.querySelector('...'); // Correct selector for song title
        let artistNameElement = document.querySelector('...'); // Correct selector for artist name
